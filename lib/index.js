...
var EventEmitter = require( 'events' ).EventEmitter,
	...
	ec2client = require( './ec2client.js' ),
...
var DEFAULTS = require( './defaults.json' ),
	VERSION = '2010-08-01', // AWS API Version
...
* @param {Function} [clbk] - callback to invoke after querying an endpoint
...
function Query( options, clbk ) {
	...
	this._ec2client = ec2client( copy( opts ) );
	...
	// Bind event listeners if provided a callback...
	if ( clbk ) {
	...
	*	Event listener invoked when a query errors.
	*
	* @private
	...
	*/
	...
	/**
	* FUNCTION: onData( evt )
	*	Event listener invoked when a query returns data.
	*
	* @private
